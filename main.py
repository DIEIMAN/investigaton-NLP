...
if __name__ == "__main__":
    ...
    results_dir = f"data/results/longmemeval_{config.longmemeval_dataset_type}_embeddings_{config.embedding_model_name.replace('/', '_')}_memory_{config.memory_model_name.replace('/', '_')}_judge_{config.judge_model_name.replace('/', '_')}"
